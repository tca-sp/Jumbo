...
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_schnorrsig_aggrate_sign(
    const secp256k1_context* ctx,
...
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_schnorrsig_aggrate_verify(
    const secp256k1_context* ctx,
    secp256k1_scratch_space *scratch,
    unsigned char *aggsig,
    size_t n_aggsig,
