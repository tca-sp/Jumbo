...
import (
	"bytes"
	"crypto/sha256"
	ba "jumbo/order/smvba/signaturefreemvba/binaryagreement"
	rbc "jumbo/order/smvba/signaturefreemvba/rbcwithfinish"
	pb "jumbo/struct"
	"encoding/binary"
	"fmt"
)

func New_mvba(node_num int, K int, id int, round int, sendMsgCH chan pb.SendMsg, bamshCH chan pb.BAMsg, rbcmsgCH chan pb.RBCMsg, check_input_rbc func([]byte, [][]int32, chan bool) bool, lastcommit []byte, input []byte, outputCH chan []byte, broadcastheights [][]int32) *MVBA {
